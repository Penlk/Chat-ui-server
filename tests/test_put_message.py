...
# Тест PUT запроса для обновления сообщения
url = "http://localhost:8003/api/chat/messages/5/"  # message_id из списка сообщений
headers = {
...
data = {
    "message": "Обновленное сообщение через PUT запрос",
    "conversation_id": 2,  # conversation_id из списка сообщений
    "is_bot": False,
    "message_type": 0
}

try:
    print("Отправляем PUT запрос для обновления сообщения...")
    print(f"URL: {url}")
