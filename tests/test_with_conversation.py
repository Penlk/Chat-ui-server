...
# Запрос с conversation
data = {
    "message": "Тестовое сообщение",
    "conversation": 1,  # Указываем conversation
    "is_bot": False,
    "message_type": 0
}

try:
    print("Отправляем тестовый запрос с conversation...")
    print(f"URL: {url}")
    ...
    if response.status_code == 200:
        print("✅ Успешно! Получаем stream...")
        # Читаем первые несколько строк stream
