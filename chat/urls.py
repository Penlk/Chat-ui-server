...
from .views import ConversationViewSet, MessageViewSet, PromptViewSet, EmbeddingDocumentViewSet, SettingViewSet, ProjectViewSet
...
router.register(r'projects', ProjectViewSet, basename='projectModel')
